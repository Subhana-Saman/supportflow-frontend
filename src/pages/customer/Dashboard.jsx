...
const CustomerDashboard = () => {
  ...
  const statCards = [
    ...
    { title: 'Open Tickets', value: stats?.openTickets || 0, icon: AlertCircle, gradient: 'from-amber-500 to-amber-600' },
    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 mb-6 text-white shadow-xl shadow-blue-500/25">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="text-blue-100 mt-1">Here's what's happening with your support tickets.</p>
          </div>
          <Link to="/customer/tickets/create" className="bg-white/20 hover:bg-white/30 text-white font-semibold px-6 py-2.5 rounded-xl backdrop-blur-sm transition-all duration-200 flex items-center gap-2">
            <PlusCircle size={18} />
            New Ticket
          </Link>
        </div>
      ...
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-700/50 shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link to="/customer/tickets" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 text-sm font-medium flex items-center gap-1">
            View all
            <ArrowRight size={16} />
          </Link>
        </div>
        {tickets.length > 0 ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">Create your first support ticket</p>
