...
import { Search, Loader, Filter, Ticket } from 'lucide-react';  // ⭐ Added Ticket here
    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Manage and respond to support tickets</p>
        </div>
      </div>
